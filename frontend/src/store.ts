  ...
  persist(
    (set, get) => ({
      ...
      setUserPassword: (userPassword) =>
        set((state) => ({ userPassword: userPassword })),
      userConfirmPassword: "",
      setUserConfirmPassword: (userConfirmPassword) =>
        set((state) => ({ userConfirmPassword: userConfirmPassword })),
      showCart: false,
      ...
      storeId: "",
      setStoreId: (storeId) => set((state) => ({ storeId: storeId })),
    }),
    {
